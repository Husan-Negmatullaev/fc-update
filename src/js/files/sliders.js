...
import Swiper, { Navigation, Pagination, Thumbs, Autoplay, Controller } from 'swiper';
/*
...
function initSliders() {
  ...
  if (document.querySelector('.google-reviews__reviews')) {
    new Swiper('.google-reviews__reviews', {
      modules: [Navigation],
      observer: true,
      observeParents: true,
      watchOverflow: false,
  ...
  if (document.querySelector('.index-news__body')) {
    new Swiper('.index-news__body', {
      modules: [Navigation, Pagination],
      observer: true,
      spaceBetween: 8,
      observeParents: true,
